...
class NetPlot:
    ...
    def _getMXgraphShape(self, nodeType):
        ...
        if nodeType == "router":
            return {
                "style": "shape=mxgraph.cisco19.rect;prIcon=router;fillColor=#FAFAFA;strokeColor=#005073;html=1;",
                "width": "50",
                "height": "50",
                "nodeLevel": "1",
            }
            ...
            return {
                "style": "shape=mxgraph.cisco19.rect;prIcon=l2_switch;fillColor=#FAFAFA;strokeColor=#005073;html=1;",
                "width": "50",
                "height": "50",
                "nodeLevel": "3",
            }
            ...
            return {
                "style": "shape=mxgraph.cisco19.rect;prIcon=l3_switch;fillColor=#FAFAFA;strokeColor=#005073;html=1;",
                "width": "50",
                "height": "50",
                "nodeLevel": "2",
            }
            ...
            return {
                "style": "shape=mxgraph.cisco19.rect;prIcon=firewall;fillColor=#FAFAFA;strokeColor=#005073;html=1;",
                "width": "64",
                "height": "50",
                "nodeLevel": "2",
            }
            ...
            return {
                "style": "shape=mxgraph.cisco19.rect;prIcon=server;fillColor=#FAFAFA;strokeColor=#005073;html=1;",
                "width": "27",
                "height": "50",
                "nodeLevel": "4",
            }
        ...
        try:
            for mxCell in self.root:
                if mxCell.attrib["id"] == sourceNodeID:
                    logging.debug(
                        "Source Node ID {} found".format(sourceNodeID)
                    )
                    break
            return
        except Exception as e:
